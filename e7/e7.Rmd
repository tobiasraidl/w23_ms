...
## 6
Compute also the scores to the rotated principal components, and present loadings and scores in a biplot. What are major differences to the robust factor
analysis solution?
```{r}
